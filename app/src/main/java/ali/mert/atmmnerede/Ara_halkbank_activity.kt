...
class Ara_halkbank_activity : ComponentActivity(), AdapterView.OnItemClickListener {
    ...
    lateinit var binding: LayoutAramaHalkbankBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true){
            override fun handleOnBackPressed() {
                val intent = Intent(this@Ara_halkbank_activity, BankalarListesi_activity::class.java)
        ...
        AdapterView.OnItemSelectedListener{
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                try {
                    var secilenilisim = binding.spinnerHalkbankIl.selectedItem
        ...
        binding.buttonHalkbankEnyakinatm.setOnClickListener(){
            try {
    ...
    override fun onItemClick(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
        try {
            ...
            arananilisim = binding.spinnerHalkbankIl.selectedItem.toString()
            var arananil = PlakaToCity.reverseMap[arananilisim]
            arananilce = binding.spinnerHalkbankIlce.selectedItem.toString()
