...
class Ara_denizbank_activity : ComponentActivity(), AdapterView.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        call?.enqueue(object : Callback<List<PostModel_banka?>?> {
            override fun onResponse(
                ...
                binding.spinnerDenizbankIl.adapter = adapter
            }
        ...
        binding.spinnerDenizbankIl.onItemSelectedListener = object :
        AdapterView.OnItemSelectedListener{
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                var secilenilisim = binding.spinnerDenizbankIl.selectedItem
                ...
                var rf2 = Retrofit.Builder()
                    ...
                    .addConverterFactory(GsonConverterFactory.create())
                    .build()
                var API2 = rf.create(RetrofitInterface_denizbank::class.java)
                var call2 = API2.post
        ...
        binding.spinnerDenizbankIlce.onItemSelectedListener = object :
        AdapterView.OnItemSelectedListener{
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                var secilenillisim = binding.spinnerDenizbankIl.selectedItem
                var secilenill = PlakaToCity.reverseMap[secilenillisim]
                var secilenilce = binding.spinnerDenizbankIlce.selectedItem

                var rf3 = Retrofit.Builder()
                    .baseUrl(RetrofitInterface_denizbank.BASE_URL)
                    .addConverterFactory(GsonConverterFactory.create())
                    .build()
                var API3 = rf.create(RetrofitInterface_denizbank::class.java)
                var call3 = API3.post
                ...
                call3?.enqueue(object : Callback<List<PostModel_banka?>?>{
                    override fun onResponse(
                        ...
                        for (i in postlist3!!.indices){
                            if (postlist3!![i]!!.city == secilenill && postlist3!![i]!!.district == secilenilce){
    ...
    override fun onItemClick(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
        ...
        arananilce = binding.spinnerDenizbankIlce.selectedItem.toString()
        val intent = Intent(this@Ara_denizbank_activity, Bilgi_denizbank_activity::class.java)
