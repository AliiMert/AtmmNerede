...
class Ara_ing_activity : ComponentActivity(), AdapterView.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true){
            override fun handleOnBackPressed() {
                val intent = Intent(this@Ara_ing_activity, BankalarListesi_activity::class.java)
        ...
        AdapterView.OnItemSelectedListener{
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                try {
                    var secilenilisim = binding.spinnerIngIl.selectedItem
            ...
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                try {
                    ...
                    var rf3 = Retrofit.Builder()
                        ...
                        .addConverterFactory(GsonConverterFactory.create())
                        .build()
                    var API3 = rf3.create(RetrofitInterface_ing::class.java)
                    var call3 = API3.post
        ...
        binding.buttonIngEnyakinatm.setOnClickListener(){
            try {
    ...
    override fun onItemClick(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
        try {
            ...
            arananilisim = binding.spinnerIngIl.selectedItem.toString()
