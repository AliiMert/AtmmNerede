    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true){
            override fun handleOnBackPressed() {
                val intent = Intent(this@Ara_garanti_activity, BankalarListesi_activity::class.java)
            ...
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                try {
                    ...
                    var rf3 = Retrofit.Builder()
                        ...
                        .addConverterFactory(GsonConverterFactory.create())
                        .build()
                    var API3 = rf3.create(RetrofitInterface_garanti::class.java)
                    var call3 = API3.post
        ...
        binding.buttonGarantiEnyakinatm.setOnClickListener(){
            try {
    ...
    private fun getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                Toast.makeText(this, "Lütfen konum servislerini aktifleştirin.", Toast.LENGTH_LONG).show()
                return
            }
